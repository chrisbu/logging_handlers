...
class Parser {
  ...
  Parser(SourceFile file, String text, {Map<String, String> otherFiles,
...
keyframe:
      ...
      case TokenKind.DIRECTIVE_INCLUDE:
        ...
        if (_otherFiles.containsKey(url)) {
          ...
          Parser parser = new Parser(new SourceFile.text(url, contents),
              contents, otherFiles: _otherFiles, start: 0, baseUrl: _baseUrl);
